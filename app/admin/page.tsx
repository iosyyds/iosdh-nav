            ...
            <>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 text-center">
                  <div className="font-bold tracking-tight text-2xl text-[#6366f1]">
                    {Object.values(data.categories).reduce((n, a) => n + a.length, 0)}
                  </div>
                  <div className="font-sans text-xs text-gray-400 mt-1">收录站点</div>
                </div>
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 text-center">
                  <div className="font-bold tracking-tight text-2xl text-[#06b6d4]">
                    {Object.keys(data.categories).length}
                  </div>
                  <div className="font-sans text-xs text-gray-400 mt-1">细分分类</div>
                </div>
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 text-center">
                  <div className="font-bold tracking-tight text-2xl text-[#f59e0b]">
                    {data.navGroups?.length || 0}
                  </div>
                  <div className="font-sans text-xs text-gray-400 mt-1">大板块</div>
                </div>
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 text-center">
                  <div className="font-bold tracking-tight text-2xl text-[#10b981]">
                    {new Date().toLocaleDateString("zh-CN")}
                  </div>
                  <div className="font-sans text-xs text-gray-400 mt-1">今日日期</div>
                </div>
              </div>
